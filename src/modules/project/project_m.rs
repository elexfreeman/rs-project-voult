...
impl ProjectM {
    ...
    pub async fn update(
        ...
        let item = ProjectsSql::one_project_by_id(request.id, owner_id).await?;
    ...
    pub async fn list(
        ...
        let list = ProjectsSql::list_project_by_owner_id(owner_id).await?;
    ...
    pub async fn get(
        ...
        let out = ProjectsSql::one_project_by_id(request.id, owner_id).await?;
